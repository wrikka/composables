...
describe("useIntersectionObserver", () => {
	...
	it("should initialize with default values", () => {
		const {
			...
			targetElement,
			entries,
		} = useIntersectionObserver(mockElement);
	...
	it("should stop observing", () => {
		const { stop, isIntersecting, intersectionRatio } =
			useIntersectionObserver(mockElement);
...
describe("useIntersectionObserverMultiple", () => {
	...
	it("should initialize with default values", () => {
		const { isSupported, results, entries } =
	...
	it("should track results for multiple elements", () => {
		const { results, getResult, isIntersecting, getIntersectionRatio } =
			useIntersectionObserverMultiple(mockElements);
...
describe("useLazyLoad", () => {
	...
	it("should initialize with default values", () => {
		const { isIntersecting, hasTriggered } = useLazyLoad(
			mockElement,
			mockCallback,
		);
