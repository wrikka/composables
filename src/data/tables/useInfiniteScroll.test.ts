...
describe('useInfiniteScroll', () => {
  ...
  it('should add and remove scroll event listener', () => {
    ...
    expect(target.value.addEventListener).toHaveBeenCalledWith('scroll', expect.any(Function))
    unmount()
    expect(target.value.removeEventListener).toHaveBeenCalledWith('scroll', expect.any(Function))
  })
})
