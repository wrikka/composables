...
function hexToHsl(hex: string): string {
	...
	const r = parseInt(rgbMatch[1] as string, 16) / 255;
	const g = parseInt(rgbMatch[2] as string, 16) / 255;
	const b = parseInt(rgbMatch[3] as string, 16) / 255;
...
function hslToRgb(hsl: string): string {
	...
	const h = parseInt(match[0] as string, 10) / 360;
	const s = parseInt(match[1] as string, 10) / 100;
	const l = parseInt(match[2] as string, 10) / 100;
