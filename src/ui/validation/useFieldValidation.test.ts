...
describe("useFieldValidation", () => {
	...
	it("should initialize with initial value", () => {
		const { value, error, isValid, touched, isDirty } =
			useFieldValidation<string>("initial");
	...
	it("should handle setValue with validation", () => {
		const { value, setValue, error, touched, isDirty } =
			useFieldValidation<string>("", [createRequiredRule()]);
	...
	it("should handle reset", () => {
		const { value, reset, error, touched, isDirty } =
			useFieldValidation<string>("initial", [createRequiredRule()]);
