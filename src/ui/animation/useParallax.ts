...
export function useParallax(options: UseParallaxOptions = {}) {
  ...
  const sourceWidth = computed(() => target ? elementBounding.width.value : windowWidth.value)
  const sourceHeight = computed(() => target ? elementBounding.height.value : windowHeight.value)
