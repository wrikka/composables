...
describe('useThrottle', () => {
  ...
  it('should only call on leading edge when trailing is false', () => {
    const source = ref(0)
    const callback = vi.fn()
    createComponent(source, callback, { delay: 500, leading: true, trailing: false })
  ...
  it('should only call on trailing edge when leading is false', () => {
    const source = ref(0)
    const callback = vi.fn()
    createComponent(source, callback, { delay: 500, leading: false, trailing: true })
  ...
  it('should not call if leading and trailing are false', () => {
    const source = ref(0)
    const callback = vi.fn()
    createComponent(source, callback, { delay: 500, leading: false, trailing: false })
  ...
  it('should flush pending calls', () => {
    const source = ref(0)
    const callback = vi.fn()
    const wrapper = createComponent(source, callback, { delay: 500, leading: false })
