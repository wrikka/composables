import { computed, type MaybeRef, type Ref, ref, watch } from "vue";
import { type UseSpringOptions, useSpring } from "./useSpring";
...
export function useMotion(
	...
	const style = computed(() => {
		...
		if (motionRefs.rotate)
			transforms.push(`rotate(${motionRefs.rotate.value}deg)`);
